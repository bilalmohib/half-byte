...
import {
  followUsData,
  IFollowUsData,
} from "@/components/page-components/Home/ContactUsSection/ContactUsFollowUsSection/data";
          ...
          >
            <Image
              ...
              width={
                width && width > 768
                  ? item.image.width
                  : item.image.mobileWidth
              }
              height={
                width && width > 768
                  ? item.image.height
                  : item.image.mobileHeight
              }
            />
          </Link>
        ))}
