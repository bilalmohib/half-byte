      ...
      <div className="relative w-full overflow-hidden rounded-[10px] bg-primary">
        ...
        <div className="relative z-10 flex flex-col gap-6.25 md:gap-11.5 lg:gap-15.75 pt-24.75 lg:pt-28.75 pb-24.75 md:pb-24.25 lg:pb-26.5 px-4">
          <Heading2 className="text-[32px]! sm:text-4xl! md:text-4xl! lg:text-5xl! leading-tight! md:leading-15.5! text-white! text-center!">
            ...
            <br className="hidden md:block" /> Smart Technology?
          </Heading2>
          <div className="flex flex-col ssm:flex-row gap-2.75 md:gap-5.5 lg:gap-5 justify-center items-center">
            <Button
              ...
              className="bg-white! hover:bg-white/90! w-full ssm:w-38.25! md:w-47.5! lg:w-55! h-11! md:h-13.5! lg:h-15! border border-white border-solid text-primary! rounded-[53px]! p-2.5! text-[15px] md:text-base lg:text-xl font-normal"
            >
              Get A Consultation
            </Button>
            <Button
              ...
              variant="default"
              onClick={() => goToHomeSection("contact-us", pathname, router)}
              className="bg-transparent! w-full ssm:w-38.25! md:w-47.5! lg:w-55! h-11! md:h-13.5! lg:h-15! hover:bg-transparent! text-white! border border-white border-solid rounded-[53px]! p-2.5! text-[15px] md:text-base lg:text-xl font-roboto font-normal"
            >
              Contact Us
            </Button>
          </div>
